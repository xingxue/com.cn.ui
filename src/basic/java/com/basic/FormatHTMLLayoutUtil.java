...
public class FormatHTMLLayoutUtil extends HTMLLayout {
	public FormatHTMLLayoutUtil() {
	}
	...
	public String format(LoggingEvent event) {
		...
		sbuf.append("<td>");
		sbuf.append(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
	...
	public String getHeader() {
		...
		sbuf.append("<meta charset=\"UTF-8\"/>" + Layout.LINE_SEP);
		...
		sbuf.append("<th>图片</th>" + Layout.LINE_SEP);
		sbuf.append("</tr>" + Layout.LINE_SEP);
